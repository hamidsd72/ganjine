...
Route::get('landing-pages/{slug}',function($slug) {
    $page = \App\Menu::where('slug', $slug)->first();
    return view('user.landing',compact('page'));
})->name('landing.page');
...
Route::group(['prefix' => 'admin', 'namespace' => 'App\Http\Controllers\Admin', 'middleware' => ['auth', 'Admin']], function () {
    ...
    // custom create
    Route::get('menu/information/create/{id}', 'MenuInformationController@create')->name('admin-menu-information-custom-create');
    // filter
    Route::get('menu/information/filter/{id}', 'MenuInformationController@index')->name('admin-menu-information-filter-by-id');
    Route::resource('admin-navbar', 'NavbarController');
    Route::get('admin-navbar/custom/create/{id}', 'NavbarController@create')->name('admin-navbar.custom.create');
    Route::resource('admin-learn', 'LearnController');
    Route::get('admin-learn/custom/create/{id}', 'LearnController@create')->name('admin-learn.custom.create');
    ...
    Route::get('contact-list/{slug?}', 'ContactController@index')->name('admin-contact-list');
    ...
    // items
    Route::get('item-page/{page_name}', 'ItemController@index')->name('admin-items-page');
    Route::get('item-page/{page_name}/create', 'ItemController@create')->name('admin-items-page-create');
    Route::get('item-page/{page_name}/{id}/edit', 'ItemController@edit')->name('admin-items-page-edit');
    // items crud
...
Route::group(['prefix' => '', 'namespace' => 'App\Http\Controllers\User'], function () {
    ...
    Route::get('learn', 'LearnController@index')->name('user.learn.index');
    Route::get('learn', 'LearnController@index')->name('user.learn.index');
    Route::get('learn/{id}/{slug}/show', 'LearnController@show')->name('user.learn.show');
    ...
    Route::get('sub-station/{slug}', 'SubStationController@show')->name('sub-station.show');
    Route::get('sub-station/province/{slug}', 'SubStationController@province')->name('sub-station.province.show');

    Route::resource('like-post', 'LikePostController');

    Route::get('/', 'HomeController@index')->name('user.index');
    Route::post('/search', 'SearchController@search')->name('user.search');
    Route::get('page/{slug}', 'HomeController@page_show')->name('user.page.show');

    Route::get('/forms',function (){
        return view('front.index.forms');
    })->name('forms');

    Route::get('/work',function (){
        return view('front.index.work_page');
    })->name('work');

    Route::get('/news',function (){
        return view('front.index.news');
    })->name('news');
    ...
    Route::get('/contact_us',function (){
        return view('front.index.contact_us');
    })->name('contact');

    Route::get('/faq_us',function (){
        return view('front.index.faq');
    })->name('faq');

    Route::get('/banks',function (){
        return view('front.index.banks');
    })->name('banks');

    Route::get('/boors',function (){
        return view('front.index.boors');
    })->name('boors');
    ...
    Route::get('faq', 'FaqController@index')->name('user.faq.show');
    ...
    Route::get('category/material-handling/منیپولیتور/pn-ergo/real', 'HomeController@ergoـreal')->name('user.ergo.real');
    Route::get('category/material-handling/منیپولیتور/pn-ergo/column', 'HomeController@ergoـcolumn')->name('user.ergo.column');

    Route::get('category/material-handling/منیپولیتور/Liftronic/real', 'HomeController@Liftronicـreal')->name('user.Liftronic.real');
    Route::get('category/material-handling/منیپولیتور/Liftronic/column', 'HomeController@Liftronicـcolumn')->name('user.Liftronic.column');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Easy/column', 'HomeController@Easyـcolumn')->name('user.Easy.column');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Easy/ceiling', 'HomeController@Easyـceiling')->name('user.Easy.ceiling');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Easy/Liftronic', 'HomeController@EasyـLiftronic')->name('user.Easy.Liftronic');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Easy/liner', 'HomeController@Easyـliner')->name('user.Easy.liner');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Easy/real', 'HomeController@Easyـreal')->name('user.Easy.real');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Pro/column', 'HomeController@proـcolumn')->name('user.pro.column');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Pro/ceiling', 'HomeController@proـceiling')->name('user.pro.ceiling');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Pro/Liftronic', 'HomeController@proـLiftronic')->name('user.pro.Liftronic');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Pro/liner', 'HomeController@proـliner')->name('user.pro.liner');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Pro/real', 'HomeController@Proـreal')->name('user.pro.real');
    Route::get('category/material-handling/منیپولیتور/Liftronic-Pro/telescopic', 'HomeController@Proـtelescopic')->name('user.pro.telescopic');

    Route::get('blogs/{type}', 'BlogController@index')->name('user.blog.index');
    Route::get('blog/show/{slug}', 'BlogController@show')->name('user.blog.show');
    Route::post('blog/{id}', 'BlogController@comment')->name('user.blog.comment');
    ...
    Route::get('regulation-list', 'RegulationController@index')->name('user.regulation.list');
    ...
    Route::get('post-category/news/', function (){
        $item = \App\Setting::find(1);
        $items = \App\Models\EmploymentPage::orderBy('id','ASC')->where('status_link','active')->get();
        return view('user.page.introduction',compact('item','items'))->with(['title'=>'اخبار و رویداد ها']);
    })->name('user.news');
