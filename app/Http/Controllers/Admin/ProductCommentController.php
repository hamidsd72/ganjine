...
class ProductCommentController extends Controller
{
    ...
    {
        $items = Comment::where('type','product')->where('reply_id',0)->orderBy('id','desc')->paginate(20);
        return view('admin.product.comment.index', compact('items'), ['title' => 'نظرات محصولات']);
    }
