...
class ContactController extends Controller {
    ...
    public function index($slug=null) {
        if ($slug)  $items = Contact::where('part', $slug)->get();
        else        $items = Contact::get();
    ...
    public function update(Request $request) {
        ...
        try {
            ...
            if ($request->hasFile('employ_pic')) {
                ...
                $item->employ_pic = file_store($request->employ_pic, 'asset/uploads/employment/photos/', 'pic-');
            }

            if (isset($request->employ_pic_active)) $item->employ_pic_active = 'active';
            else $item->employ_pic_active = 'pending';
    ...
    public function update1(Request $request,$id) {
        ...
        try {
            ...
            if ($request->hasFile('pic')) {
                ...
                $item->pic = file_store($request->pic, 'asset/uploads/employment/photos/', 'picPage-');
            }
            $item->update();
    ...
    public function status($type,$id) {
        ...
        $item = EmploymentPage::find($id);
        if($item->$type=='active') $item->$type='pending';
        else $item->$type='active';
        $item->update();
