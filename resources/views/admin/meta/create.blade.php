...
@section('body')
    <div class="condition pull-right w-100 mb-2">
        ...
        <form action="{{ route('meta-store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
                <div class="form-group{{ $errors->has('name_page') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="name_page" class="form-label">* url :</label>
                            <input type="text" class="form-control d-ltr" id="name_page" name="name_page" min="" value=""
                                   required/>
                ...
                <div class="form-group{{ $errors->has('priority') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="priority" name="priority" min="" value="{{old('priority')}}"
                                   />
                ...
                <div class="form-group{{ $errors->has('title_page') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="title_page" name="title_page" min="" value="{{old('title_page')}}"
                                   required/>
                ...
                <div class="form-group{{ $errors->has('keyword') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="keyword" name="keyword" min="" value="{{old('keyword')}}"
                                   required/>
                            ...
                            <div class="form-group{{ $errors->has('title_page_en') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control d-ltr" id="title_page_en" name="title_page_en" min="" value="{{old('title_page_en')}}"
                                        />
                            ...
                            <div class="form-group{{ $errors->has('keyword_en') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control d-ltr" id="keyword_en" name="keyword_en" min="" value="{{old('keyword_en')}}"
                                               />
                            ...
                            <div class="form-group{{ $errors->has('description_en') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="description_en" class="form-control d-ltr">{{old('description_en')}}</textarea>
