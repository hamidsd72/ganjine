                            ...
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" id="slug" name="slug" value="{{ $item->slug }}" />
                                        @if ($errors->has('title'))
                            ...
                            <div class="form-group{{ $errors->has('writer') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="writer" name="writer" value="{{ $item->writer }}" required/>
                            ...
                            <div class="form-group{{ $errors->has('keywordsseo') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="keywordsseo" name="keywordsseo" placeholder="کلمات را با ویرگول جدا کنید"  value="{{ $item->keywordsseo }}"/>
