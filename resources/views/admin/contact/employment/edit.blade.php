...
@section('body')
    <div class="condition pull-right w-100 mb-2">
        ...
        <form action="{{ route('admin.employment.page.update') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            @csrf
            <fieldset>
                            ...
                            <div class="form-group{{ $errors->has('employ_unit') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control key_word" id="employ_unit" name="employ_unit" value="{{ $item->employ_unit }}" required/>
                            ...
                            <div class="form-group{{ $errors->has('employ_type') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control key_word" id="employ_type" name="employ_type" value="{{ $item->employ_type }}" required/>
                            ...
                            <div class="form-group{{ $errors->has('employ_know') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control key_word" id="employ_know" name="employ_know" value="{{ $item->employ_know }}" required/>
                            ...
                            <div class="form-group{{ $errors->has('employ_text') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="textarea ckeditor form-control" id="employ_text" name="employ_text" cols="30" rows="10">{{ $item->employ_text }}</textarea>
...
{{--                        </div>--}}
                ...
                <div class="form-group{{ $errors->has('employ_pic_active') ? ' has-error' : '' }}">
                    <div class="col-md-12">
                        ...
                        <input type="checkbox" id="employ_pic_active" name="employ_pic_active" {{$item->employ_pic_active=='active'?'checked':''}} value="active"/>
                ...
                <div class="form-group{{ $errors->has('employ_pic') ? ' has-error' : '' }}">
                    <div class="col-md-12">
                        ...
                        <input type="file" class="form-control" id="employ_pic" name="employ_pic" accept="image/*" value="{{ old('employ_pic') }}"/>
