                            ...
                            <div class="form-group{{ $errors->has('mobile1') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control d-ltr" id="mobile1" name="mobile1" value="{{ $item->mobile1 }}"/>
                            ...
                            <div class="form-group{{ $errors->has('mobile2') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control d-ltr" id="mobile2" name="mobile2" value="{{ $item->mobile2 }}"/>
                            ...
                            <div class="form-group{{ $errors->has('phone1') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control d-ltr" id="phone1" name="phone1" value="{{ $item->phone1 }}"/>
                            ...
                            <div class="form-group{{ $errors->has('phone2') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control d-ltr" id="phone2" name="phone2" value="{{ $item->phone2 }}"/>
                        ...
                        <div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="textarea ckeditor form-control" id="text" name="text" cols="30" rows="10">{{ $item->text }}</textarea>
                                    @if ($errors->has('text'))
                ...
                <div class="form-group{{ $errors->has('map') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="map" name="map" value="{{ $item->map }}"/>
                            @if ($errors->has('map'))
                ...
                <div class="form-group{{ $errors->has('email1') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="email1" name="email1" value="{{ $item->email1 }}"/>
                ...
                <div class="form-group{{ $errors->has('email2') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="email2" name="email2" value="{{ $item->email2 }}"/>
                ...
                <div class="form-group{{ $errors->has('telegram') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="telegram" name="telegram" value="{{ $item->telegram }}"/>
                ...
                <div class="form-group{{ $errors->has('instagram') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="instagram" name="instagram" value="{{ $item->instagram }}"/>
                ...
                <div class="form-group{{ $errors->has('whatsapp') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="whatsapp" name="whatsapp" value="{{ $item->whatsapp }}"/>
                ...
                <div class="form-group{{ $errors->has('facebook') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="facebook" name="facebook" value="{{ $item->facebook }}"/>
                ...
                <div class="form-group{{ $errors->has('linkdin') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="linkdin" name="linkdin" value="{{ $item->linkdin }}"/>
                ...
                <div class="form-group{{ $errors->has('aparat') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control d-ltr" id="aparat" name="aparat" value="{{ $item->aparat }}"/>
