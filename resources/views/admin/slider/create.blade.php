...
@section('body')
    <div class="condition pull-right w-100 mb-2">
        ...
        <form action="{{ route('admin-slider-store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
...
{{--                </div>--}}
                ...
                <div class="form-group{{ $errors->has('sort_id') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control" id="sort_id" name="sort_id" min="1" value="1" required/>
                ...
                <div class="form-group{{ $errors->has('url_name') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="url_name" class="form-control d-ltr" id="url_name" name="url_name"/>
                ...
                <div class="form-group{{ $errors->has('url2_name') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="url2_name" class="form-control d-ltr" id="url2_name" name="url2_name"/>
                ...
                <div class="form-group{{ $errors->has('url2') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="url2" class="form-control d-ltr" id="url2" name="url2"/>
                            @if ($errors->has('url2'))
                ...
                <div class="form-group{{ $errors->has('url_color') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="color" class="form-control d-ltr" id="url_color" name="url_color" value="#000000f2"/>
                ...
                <div class="form-group{{ $errors->has('url_background') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="color" class="form-control d-ltr" id="url_background" name="url_background" value="#ffda94"/>
                ...
                <div class="form-group{{ $errors->has('url_hover_color') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="color" class="form-control d-ltr" id="url_hover_color" name="url_hover_color" value="#3241ff"/>
                ...
                <div class="form-group{{ $errors->has('url_hover_background') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="color" class="form-control d-ltr" id="url_hover_background" name="url_hover_background" value="#f8f9fa"/>
                ...
                <div class="form-group{{ $errors->has('photo') ? ' has-error' : '' }}">
                    <div class="col-md-12">
                        ...
                        <input type="file" class="form-control" id="photo" name="photo" accept=".jpg" value="{{ old('photo') }}"/>
                        @if ($errors->has('photo'))
                ...
                {{-- <div class="form-group{{ $errors->has('img_top') ? ' has-error' : '' }}">
                    <div class="col-md-12">
                        ...
                        <input type="file" class="form-control" id="img_top" name="img_top" accept=".png" value="{{ old('img_top') }}"/>
