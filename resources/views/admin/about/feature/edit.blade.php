...
@section('body')
    <div class="condition pull-right w-100 mb-2">
        ...
        <form action="{{ route('admin-about-feature-update', $item->id) }}" method="POST"
              enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
                <div class="form-group{{ $errors->has('pic') ? ' has-error' : '' }}">
                    <div class="col-md-12">
                        <label for="photo" class="form-label">آیکون(در صورت انتخاب تصویر جدید جایگزین می شود) :</label>
                    ...
                    @if($item->pic)
                        <div class="col-sm-2 mt-3">
                            <img src="{{url($item->pic)}}"  style="height: 50px;background: rgba(0,0,0,0.1)" alt="">
                        </div>
                    @endif
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="text" name="text"
                                               value="{{ $item->text }}"
                                               placeholder="لطفا متن را کوتاه وارد کنید" required/>
                                        @if ($errors->has('text'))
