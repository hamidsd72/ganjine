...
@section('body')
    <div class="condition pull-right w-100 mb-2">
        ...
        <form action="{{ route('admin-about-bank-store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <select name="type" id="type" class="form-control">
                                <option value="1" {{old('type')==1?'selected':''}}>شماره حاب بانکی</option>
                                <option value="2" {{old('type')==2?'selected':''}}>بورس انرژی</option>
                                <option value="3" {{old('type')==3?'selected':''}}>بورس کالا</option>
                            </select>
                            @if ($errors->has('type'))
                            ...
                            <div class="form-group{{ $errors->has('shaba') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control text-left" dir="ltr" id="shaba" name="shaba" value="{{ old('shaba') }}"/>
                                        @if ($errors->has('shaba'))
                            ...
                            <div class="form-group{{ $errors->has('hesab') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control text-left" dir="ltr" id="hesab" name="hesab" value="{{ old('hesab') }}"/>
                                        @if ($errors->has('hesab'))
                            ...
                            <div class="form-group{{ $errors->has('card') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="number" class="form-control text-left" dir="ltr" id="card" name="card" value="{{ old('card') }}"/>
                                        @if ($errors->has('card'))
