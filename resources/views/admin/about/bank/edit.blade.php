                            ...
                            <div class="form-group{{ $errors->has('shaba') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control text-left" dir="ltr" id="shaba" name="shaba" value="{{ $item->shaba }}"/>
                                        @if ($errors->has('shaba'))
                            ...
                            <div class="form-group{{ $errors->has('hesab') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control text-left" dir="ltr" id="hesab" name="hesab" value="{{ $item->hesab }}"/>
                                        @if ($errors->has('hesab'))
