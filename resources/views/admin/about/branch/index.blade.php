...
@section('body')
    ...
    <div class="condition pull-right w-100 mb-2">
                ...
                <div class="form-group{{ $errors->has('title_branch') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="title_branch" name="title_branch" value="{{ $about->title_branch }}" required/>
                ...
                <div class="form-group{{ $errors->has('text_branch') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="text_branch" name="text_branch" value="{{ $about->text_branch }}" />
        ...
        <div class="p-3">
            <a href="{{ route('admin-about-branch-create') }}" class="btn btn-success mb-2"><i class="fa fa-plus ml-2"></i>افزودن</a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($item->status == 'pending')
                                <a href="{{route('admin-about-branch-active',['status',$item->id])}}" title="نمایش در سایت" ><i class="fa fa-check text-success"></i></a>
                            @endif
                            @if($item->status == 'active')
                                <a href="{{route('admin-about-branch-active',['status',$item->id])}}" title="عدم نمایش در سایت" ><i class="fa fa-close text-danger"></i></a>
                            @endif
                        </td>
                        <td class="table-td-icons d-flex text-center py-2">
                            <a href="{{ route('admin-about-branch-edit', $item->id) }}" class="ml-2" title="ویرایش"><i class="fa fa-edit"></i></a>
                            @role('ادمین ارشد')
                                <a href="{{route('admin-about-branch-destroy',$item->id)}}" title="حذف" onclick="return confirm('برای حذف مطمئن هستید؟')"><i class="fa fa-trash text-danger"></i></a>
                            @endrole
                        </td>
                    </tr>
                @endforeach
