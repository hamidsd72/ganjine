                        ...
                        <div class="tab-content py-3" id="myTabContent">
                            <div class="tab-pane fade show active" id="fa" role="tabpanel" aria-labelledby="farsi-tab">
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="hidden" class="form-control" id="slug" name="slug" value="{{ $item->slug }}" required/>
                                            @if ($errors->has('name'))
                                ...
                                <div class="textarea-container form-group{{ $errors->has('page_content') ? ' has-error' : '' }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="textarea ckeditor form-control" id="page_content" name="page_content" required>{{ $item->page_content }}</textarea>
                                ...
                                <div class="col-md-12 form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                                    ...
                                    <input type="url" class="form-control text-left" dir="ltr" id="link" name="link" value="{{ $item->link }}" />
                                    @if ($errors->has('link'))
                                ...
                                <div class="form-group{{ $errors->has('titleseo') ? ' has-error' : '' }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="titleseo" name="titleseo" value="{{ $item->meta->title_page }}" />
                                ...
                                <div class="form-group{{ $errors->has('keywordsseo') ? ' has-error' : '' }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="keywordsseo" name="keywordsseo" placeholder="کلمات را با ویرگول جدا کنید"  value="{{ $item->meta->keyword }}"/>
                                ...
                                <div class="form-group{{ $errors->has('descriptionseo') ? ' has-error' : '' }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="descriptionseo" name="descriptionseo" value="{{ $item->meta->description }}"/>
                                ...
                                <div class="form-group{{ $errors->has('priority') ? ' has-error' : '' }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="priority" name="priority" value="{{ $item->meta->priority }}" />
                                ...
                                <div class="form-group{{ $errors->has('schema') ? ' has-error' : '' }}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" rows="20" id="schema" name="schema">{{ $item->meta->schema }}</textarea>
