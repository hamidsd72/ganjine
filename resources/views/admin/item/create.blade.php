...
@section('body')
    <div class="condition pull-right w-100 mb-2">
        ...
        <form action="{{ route('admin-item.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="textarea-container form-group{{ $errors->has('text') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="textarea ckeditor form-control" id="text" name="text">{{ old('text') }}</textarea>
                                        @if ($errors->has('text'))
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control text-left" id="link" name="link" value="{{ old('link')}}"/>
                            @if ($errors->has('link'))
                    ...
                    <div class="col-lg-6">
                        <div class="form-group{{ $errors->has('section') ? ' has-error' : '' }}">
                            ...
                            <input type="number" class="form-control text-left" placeholder="محل نمایش در کدام سکشن باشد" dir="ltr" id="section" name="section" value="{{ old('section')}}" required/>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
                            ...
                            <input type="number" class="form-control text-left" placeholder="آیتم چندم در یک سکشن" dir="ltr" id="position" name="position" value="{{ old('position')}}" required/>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group{{ $errors->has('sort') ? ' has-error' : '' }}">
                            ...
                            <input type="number" class="form-control text-left" dir="ltr" id="sort" name="sort" value="{{ old('sort')}}" required/>
                            @if ($errors->has('sort'))
